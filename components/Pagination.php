...
class Pagination
{
     ...
     */
    public function __construct($total, $currentPage, $limit, $index, $sort_field, $sort_order)
    {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        // $currentURI = preg_replace('~/[a-z]+/[a-z]+/page-[0-9]+~', '/', $currentURI);
        // die($currentURI);
        # Формируем HTML код ссылки и возвращаем
        return
                '<li class="page-item"><a class="page-link" href="' . 
                '/' . $this->sort_field . '/' . $this->sort_order . '/'
                 . $this->index . $page . '">' . $text . '</a></li>';
    }
